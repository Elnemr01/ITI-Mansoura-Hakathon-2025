      ...
      <div className="firstPart">
        ...
        <ul className="appointmentData">
          ...
          <li className="dateAndTime">
            <span>date & time:</span> {appointmentData.date?.dayNum}{" "}
            {appointmentData.date?.day} {appointmentData.date?.year} |{" "}
            {appointmentData.time}
          </li>
        </ul>
      </div>
      <div className="buttons">
        <button onClick={() => dispatch(cancelAppointment(appointmentData.id))}>
          cancel appointment
        </button>
      </div>
    </div>
